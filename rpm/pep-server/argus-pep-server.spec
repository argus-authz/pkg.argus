...
%{_localstatedir}/lib/argus/pepd/lib/avalon-framework-*.jar
%{_localstatedir}/lib/argus/pepd/lib/checker-qual-*.jar
%{_localstatedir}/lib/argus/pepd/lib/commons-beanutils-*.jar
%{_localstatedir}/lib/argus/pepd/lib/commons-codec-*.jar
%{_localstatedir}/lib/argus/pepd/lib/commons-collections4-*.jar
...
%{_localstatedir}/lib/argus/pepd/lib/commons-lang3-*.jar
%{_localstatedir}/lib/argus/pepd/lib/commons-logging-*.jar
%{_localstatedir}/lib/argus/pepd/lib/commons-text-*.jar
%{_localstatedir}/lib/argus/pepd/lib/conscrypt-*.jar
%{_localstatedir}/lib/argus/pepd/lib/ehcache-*.jar
%{_localstatedir}/lib/argus/pepd/lib/error_prone_annotations-*.jar
%{_localstatedir}/lib/argus/pepd/lib/esapi-*.jar
%{_localstatedir}/lib/argus/pepd/lib/failureaccess-*.jar
%{_localstatedir}/lib/argus/pepd/lib/guava-*.jar
%{_localstatedir}/lib/argus/pepd/lib/http2-*.jar
%{_localstatedir}/lib/argus/pepd/lib/ini4j-*.jar
%{_localstatedir}/lib/argus/pepd/lib/j2objc-annotations-*.jar
...
%{_localstatedir}/lib/argus/pepd/lib/jsr305-*.jar
%{_localstatedir}/lib/argus/pepd/lib/jul-to-slf4j-*.jar
%{_localstatedir}/lib/argus/pepd/lib/listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar
%{_localstatedir}/lib/argus/pepd/lib/log4j-*.jar
...
* Mon Jan 9 2017 Andrea Ceccanti <andrea.ceccanti@cnaf.infn.it> 1.7.3-1
